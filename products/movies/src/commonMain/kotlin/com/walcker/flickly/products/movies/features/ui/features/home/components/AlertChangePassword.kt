...
import com.walcker.flickly.products.movies.features.data.settings.PasswordSettingsHolder.MAX_SIZE
...
internal fun AlertChangePassword(
    ...
    val isLengthValid = newPassword.length in MIN_SIZE..MAX_SIZE
    ...
    AlertDialog(
        ...
        confirmButton = {
            Button(
                ...
                enabled = isLengthValid && confirmPassword.length in MIN_SIZE..MAX_SIZE
